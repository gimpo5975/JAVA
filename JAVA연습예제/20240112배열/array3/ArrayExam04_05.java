...
public class ArrayExam04_05 {
	...
	public static void main(String[] args) {
		...
		int arrayQuantity[] = new int[4];
		int arrayPrice[] = new int[4];
		...
		while (run) {
			...
			case 1:// 1번 아아
				...
				arrayQuantity[0] = quantity;// 아메리카노 주문수량 배열에 저장
				price = quantity * COFFE_PRICE;// 금액 연산
				arrayPrice[0] = price;// 금액배열에 금액 저장
			...
			case 2:// 2번 라떼
				System.out.printf("주문 수량을 입력 >> ");
				quantity = Integer.parseInt(sc.nextLine());// 주문수량 받기
				arrayQuantity[1] = quantity;// 라떼 주문수량 배열에 저장
				price = quantity * LATTE_PRICE;// 금액 연산
				arrayPrice[1] = price;// 금액배열에 금액 저장
			...
			case 3:// 3번 콜라
				System.out.printf("주문 수량을 입력 >> ");
				quantity = Integer.parseInt(sc.nextLine());// 주문수량 받기
				arrayQuantity[2] = quantity;// 콜라 주문수량 배열에 저장
				price = quantity * COKE_PRICE;// 금액 연산
				arrayPrice[2] = price;// 금액배열에 금액 저장
			...
			case 4:// 4번 홍차
				System.out.printf("주문 수량을 입력 >> ");
				quantity = Integer.parseInt(sc.nextLine());// 주문수량 받기
				arrayQuantity[3] = quantity;// 홍차 주문수량 배열에 저장
				price = quantity * RED_TEA;// 금액 연산
				arrayPrice[3] = price;// 금액배열에 금액 저장
